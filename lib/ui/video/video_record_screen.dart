...
//   VideoRecordingScreen({super.key, required this.camera});
//   @override
...
//           Duration(seconds: 10)); // Adjust the delay duration as needed
//       await _cameraController?.stopVideoRecording();

//       final recordedVideo = File(recordingPath);

//       String? videoURL = await uploadVideoToFirebase(recordedVideo);
//       return '1';
//     } catch (e) {
...
//           FirebaseStorage.instance.ref('video').child('$fileName');
...
//   void startRecordingAndUpload() async {
//     String? videoURL = await startVideoRecording();
//     if (videoURL!.isNotEmpty) {
//       print('Video recorded and uploaded. Download URL: $videoURL');
//       setState(() {
//         _isRecording = false;
//       });
//       // Handle successful recording and upload
//     } else {
//       print('Failed to record and upload video.');
//       setState(() {
//         _isRecording = false;
//       });
//       // Handle error
...
// import 'package:ichat/ui/video/preview_screen.dart';
// import 'package:path_provider/path_provider.dart';
